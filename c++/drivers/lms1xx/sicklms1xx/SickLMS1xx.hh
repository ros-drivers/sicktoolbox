...
/* Macros */
#define DEFAULT_SICK_LMS_1XX_IP_ADDR                      "192.168.0.1"  //< Default IP Address
#define DEFAULT_SICK_LMS_1XX_PORT                                (2111)  //< Sick LMS 1xx TCP/IP Port
...
#define SICK_MAX_BUFFER_LENGTH                                  (10000)  //< Maximum number of bytes
...
namespace SickToolbox {
  ...
  public:
    ...
    /** Primary constructor */
    SickLMS1xx( const std::string sick_ip_address = DEFAULT_SICK_IP_ADDRESS,
